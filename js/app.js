...
(function () {
  ...
  const CHIP_MAP = {
    '01': {
      plan: { icon: '<img src="assets/Calendar2_img.png" alt="" />', label: 'похудеть' },
      challenges: { icon: '💪', label: 'тонус мышц' },
      'short-goals': { icon: '🤸', label: 'гибкость' },
      self: { icon: '❤️', label: 'здоровье' },
    },
    '03': {
      sleep: { icon: '<img src="assets/Pillow3_img.png" alt="" />', label: 'хорошо засыпать' },
      relax: { icon: '🧘', label: 'расслабление' },
      stress: { icon: '🌿', label: 'без стресса' },
      'workouts-only': { icon: '💪', label: 'только тренировки' },
    },
    '08': {
      partner: { icon: '<img src="assets/Family_Img.png" alt="" />', label: 'с партнёром' },
  ...
  const DEFAULT_CHIPS = [
    { icon: '<img src="assets/Calendar2_img.png" alt="" />', label: 'похудеть' },
    { icon: '<img src="assets/Pillow3_img.png" alt="" />', label: 'хорошо засыпать' },
    { icon: '<img src="assets/Family_Img.png" alt="" />', label: 'семья' },
    { icon: '<img src="assets/Salad_img.png" alt="" />', label: 'здоровое питание' },
  ];
